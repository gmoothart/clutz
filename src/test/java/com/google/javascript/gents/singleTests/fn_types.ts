...
let foo: Function = function(a, b, c) { return a + b + c; };
let inferRetAny: () => any = function() {};
let typedRetVoid: () => void = function() {};
let basicParams: (p1: number, p2: string) =>
    number = function(n, s) { return n; };
...
let complex: (p1: number, p2?: boolean, ...p3) =>
    number = function(n, o, r) { return n; };
